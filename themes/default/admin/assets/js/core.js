...
function cssStyle() {
    if ($.cookie('sma_style') == 'light') {
        ...
        $('link[href="'+site.assets+'styles/dark-blue.css"]').remove();
        $('<link>')
        .appendTo('head')
    ...
    else if ($.cookie('sma_style') == 'dark-blue') {
        $('link[href="'+site.assets+'styles/dark-blue.css"]').attr('disabled', 'disabled');
        $('link[href="'+site.assets+'styles/dark-blue.css"]').remove();
        $('<link>')
            .appendTo('head')
            .attr({type: 'text/css', rel: 'stylesheet'})
            .attr('href', ''+site.assets+'styles/dark-blue.css');
    }
    else if ($.cookie('sma_style') == 'black') {
        $('link[href="'+site.assets+'styles/light.css"]').attr('disabled', 'disabled');
        $('link[href="'+site.assets+'styles/blue.css"]').attr('disabled', 'disabled');
        $('link[href="'+site.assets+'styles/light.css"]').remove();
        $('link[href="'+site.assets+'styles/blue.css"]').remove();
...
$(document).ready(function() {
    ...
    $('#cssDarkBlue').click(function(e) {
        e.preventDefault();
        $.cookie('sma_style', 'dark-blue', { path: '/' });
        cssStyle();
        return true;
    });
