...
<head>
    ...
    <link href="<?= $assets ?>styles/dark-blue.css" rel="stylesheet"/>
    ...
    <?php if ($Settings->user_rtl) { ?>
        ...
        <link href="<?= $assets ?>styles/style-rtl.min.css" rel="stylesheet"/>
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li class="bwhite noPadding">
                                ...
                                <a href="#" id="cssLight" class="grey">
                                    <i class="fa fa-stop"></i> Light
                                </a>
                                <a href="#" id="cssBlue" class="blue">
                                    <i class="fa fa-stop"></i> Blue
                                </a>
                                <a href="#" id="cssDarkBlue" class="darkBlue">
